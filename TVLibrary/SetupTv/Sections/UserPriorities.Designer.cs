namespace SetupTv.Sections
{
  partial class UserPriorities
  {
    ...
    {
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UserPriorities));
      ...
      this.numEpgGrabber = new System.Windows.Forms.NumericUpDown();
      this.lblEPG = new System.Windows.Forms.Label();
      this.groupBox10 = new System.Windows.Forms.GroupBox();
      this.gridUserPriorities = new System.Windows.Forms.DataGridView();
      ...
      ((System.ComponentModel.ISupportInitialize)(this.gridUserPriorities)).BeginInit();
      ...
      // tpTimeshifing
      // 
      this.tpTimeshifing.Controls.Add(this.label26);
      this.tpTimeshifing.Controls.Add(this.label22);
      this.tpTimeshifing.Controls.Add(this.labelCardPriority);
      this.tpTimeshifing.Controls.Add(this.groupBox11);
      ...
      this.label26.Size = new System.Drawing.Size(444, 100);
      ...
      this.label22.Size = new System.Drawing.Size(276, 13);
      this.label22.TabIndex = 86;
      this.label22.Text = "Note2: Changes will trigger a TV-Server restart.";
      // 
      // labelCardPriority
      // 
      ...
      this.groupBox11.Controls.Add(this.lblScheduler);
      this.groupBox11.Controls.Add(this.numEpgGrabber);
      ...
      this.groupBox11.Text = "System Priorities (readonly)";
      // 
      // numDefaultUser
      // 
      this.numDefaultUser.Enabled = false;
      this.numDefaultUser.Location = new System.Drawing.Point(208, 41);
      this.numDefaultUser.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
      this.numDefaultUser.Name = "numDefaultUser";
      this.numDefaultUser.Size = new System.Drawing.Size(87, 20);
      this.numDefaultUser.TabIndex = 36;
      this.numDefaultUser.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
      this.numDefaultUser.Value = new decimal(new int[] {
            2,
            0,
            0,
            0});
      this.numDefaultUser.ValueChanged += new System.EventHandler(this.numDefaultUser_ValueChanged);
      // 
      // lblUsers
      // 
      this.lblUsers.AutoSize = true;
      this.lblUsers.Location = new System.Drawing.Point(8, 43);
      this.lblUsers.Name = "lblUsers";
      this.lblUsers.Size = new System.Drawing.Size(194, 13);
      this.lblUsers.TabIndex = 35;
      this.lblUsers.Text = "Default users (those not defined below):";
      // 
      // numScheduler
      // 
      this.numScheduler.Enabled = false;
      this.numScheduler.Location = new System.Drawing.Point(208, 67);
      this.numScheduler.Maximum = new decimal(new int[] {
            101,
            0,
            0,
            0});
      this.numScheduler.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
      this.numScheduler.Name = "numScheduler";
      this.numScheduler.Size = new System.Drawing.Size(87, 20);
      this.numScheduler.TabIndex = 34;
      this.numScheduler.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
      this.numScheduler.Value = new decimal(new int[] {
            101,
            0,
            0,
            0});
      this.numScheduler.ValueChanged += new System.EventHandler(this.numScheduler_ValueChanged);
      // 
      // lblScheduler
      // 
      this.lblScheduler.AutoSize = true;
      this.lblScheduler.Location = new System.Drawing.Point(7, 69);
      this.lblScheduler.Name = "lblScheduler";
      this.lblScheduler.Size = new System.Drawing.Size(58, 13);
      this.lblScheduler.TabIndex = 33;
      this.lblScheduler.Text = "Scheduler:";
      // 
      // numEpgGrabber
      // 
      this.numEpgGrabber.Enabled = false;
      this.numEpgGrabber.Location = new System.Drawing.Point(208, 15);
      this.numEpgGrabber.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
      this.numEpgGrabber.Name = "numEpgGrabber";
      this.numEpgGrabber.Size = new System.Drawing.Size(87, 20);
      this.numEpgGrabber.TabIndex = 32;
      this.numEpgGrabber.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
      this.numEpgGrabber.Value = new decimal(new int[] {
            1,
            0,
            0,
            0});
      this.numEpgGrabber.ValueChanged += new System.EventHandler(this.numEpgGrabber_ValueChanged);
      // 
      // lblEPG
      // 
      this.lblEPG.AutoSize = true;
      this.lblEPG.Location = new System.Drawing.Point(8, 17);
      this.lblEPG.Name = "lblEPG";
      this.lblEPG.Size = new System.Drawing.Size(71, 13);
      this.lblEPG.TabIndex = 31;
      this.lblEPG.Text = "EPG grabber:";
      // 
      // groupBox10
      // 
      ...
      this.groupBox10.Text = "User Priorities (customizable)";
      // 
      // gridUserPriorities
      // 
      ...
      this.gridUserPriorities.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle7;
      this.gridUserPriorities.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
      this.gridUserPriorities.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
            this.Username,
            this.Sharename});
      ...
      this.gridUserPriorities.DefaultCellStyle = dataGridViewCellStyle8;
      this.gridUserPriorities.Location = new System.Drawing.Point(4, 19);
      this.gridUserPriorities.Name = "gridUserPriorities";
      ...
      this.gridUserPriorities.RowHeadersDefaultCellStyle = dataGridViewCellStyle9;
      this.gridUserPriorities.Size = new System.Drawing.Size(435, 90);
      this.gridUserPriorities.TabIndex = 7;
      this.gridUserPriorities.UserAddedRow += new System.Windows.Forms.DataGridViewRowEventHandler(this.gridUserPriorities_UserAddedRow);
      this.gridUserPriorities.UserDeletedRow += new System.Windows.Forms.DataGridViewRowEventHandler(this.gridUserPriorities_UserDeletedRow);
      // 
      // Username
      // 
      this.Username.HeaderText = "User";
      this.Username.Name = "Username";
      this.Username.ToolTipText = "Insert username (host name of client HTPC)";
      this.Username.Width = 285;
      // 
      // Sharename
      // 
      this.Sharename.HeaderText = "Priority";
      this.Sharename.Name = "Sharename";
      this.Sharename.ToolTipText = "Insert tuning lock priority (1-100)";
      // 
      // tabControl1
      // 
      ...
      ((System.ComponentModel.ISupportInitialize)(this.gridUserPriorities)).EndInit();
    ...
    private System.Windows.Forms.DataGridView gridUserPriorities;
    private System.Windows.Forms.GroupBox groupBox11;
    private System.Windows.Forms.NumericUpDown numDefaultUser;
    private System.Windows.Forms.Label lblUsers;
    private System.Windows.Forms.NumericUpDown numScheduler;
    private System.Windows.Forms.Label lblScheduler;
    private System.Windows.Forms.NumericUpDown numEpgGrabber;
    private System.Windows.Forms.Label lblEPG;
